...
int         process_do_eor           ( D_S *d, unsigned char *src, int srclen );
...
int         process_do_charset       ( D_S *d, unsigned char *src, int srclen );
...
int         process_do_gmcp          ( D_S *d, unsigned char *src, int srclen );
int         process_sb_gmcp          ( D_S *d, unsigned char *src, int srclen );
int         process_do_mccp2         ( D_S *d, unsigned char *src, int srclen );
int         process_dont_mccp2       ( D_S *d, unsigned char *src, int srclen );
int         skip_sb                  ( D_S *d, unsigned char *src, int srclen );
void        descriptor_printf        ( D_S *d, char *fmt, ...);
int         start_mccp2              ( D_S *d );
void        process_mccp2            ( D_S *d );
int         process_do_mccp3         ( D_S *d, unsigned char *src, int srclen );
int         process_sb_mccp3         ( D_S *d, unsigned char *src, int srclen );
void        send_ga                  ( D_S *d );
void        send_eor                 ( D_S *d );
